...
bool CCameraDS::OpenCamera(int nCamID, bool bDisplayProperties, int nWidth, int nHeight, camera_data_cb cb/*=NULL*/, void* param /*= NULL*/)
{
	HRESULT hr = S_OK;
	...
	m_cGrabberCB.m_cb = cb;
	m_cGrabberCB.m_pParam = param;
	m_cGrabberCB.m_nID = nCamID;
	m_cGrabberCB.m_bCaptureVideo = TRUE;
...
CCameraDS::CSampleGrabberCB:: CSampleGrabberCB( )
{
...
STDMETHODIMP_(ULONG) CCameraDS::CSampleGrabberCB::AddRef() 
{
	return 2; 
}

STDMETHODIMP_(ULONG) CCameraDS::CSampleGrabberCB::Release() 
{
	return 1; 
}

STDMETHODIMP CCameraDS::CSampleGrabberCB::QueryInterface(REFIID riid, void ** ppv)
{
...
STDMETHODIMP CCameraDS::CSampleGrabberCB::SampleCB( double SampleTime, IMediaSample * pSample )
{
    return 0;
}
